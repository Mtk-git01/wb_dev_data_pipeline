...
from src.config import AZE_BALANCE_OF_PAYMENTS_SOURCE_NAME

def transform_aze_balance_of_payments_periodic(raw_df: pd.DataFrame) -> pd.DataFrame:
    df = raw_df.copy()
    ...
    df["source_name"] = AZE_BALANCE_OF_PAYMENTS_SOURCE_NAME
