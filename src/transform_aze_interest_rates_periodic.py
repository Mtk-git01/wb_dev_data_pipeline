...
from src.config import AZE_INTEREST_RATES_SOURCE_NAME

def transform_aze_interest_rates_periodic(raw_df: pd.DataFrame) -> pd.DataFrame:
    df = raw_df.copy()
    ...
    df["source_name"] = AZE_INTEREST_RATES_SOURCE_NAME
