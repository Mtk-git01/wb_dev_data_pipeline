...
from src.config import (
    GDP_PC_INDICATOR_CODE,
    GDP_PC_INDICATOR_NAME,
    GDP_PC_SOURCE_NAME,
)
...
def transform_wb_indicator(df: pd.DataFrame) -> pd.DataFrame:
    ...
    out["indicator_code"] = GDP_PC_INDICATOR_CODE
    out["indicator_name"] = out["indicator_name"].fillna(GDP_PC_INDICATOR_NAME)
    out["source_name"] = GDP_PC_SOURCE_NAME
