...
from src.config import (
    ODA_PER_CAPITA_INDICATOR_CODE,
    ODA_PER_CAPITA_INDICATOR_NAME,
    ODA_PER_CAPITA_SOURCE_NAME,
)
...
def transform_wb_indicator(df: pd.DataFrame) -> pd.DataFrame:
    ...
    out["indicator_code"] = ODA_PER_CAPITA_INDICATOR_CODE
    out["indicator_name"] = out["indicator_name"].fillna(ODA_PER_CAPITA_INDICATOR_NAME)
    out["source_name"] = ODA_PER_CAPITA_SOURCE_NAME
