...
from src.config import WB_API_BASE, GIRLS_PRIMARY_COMPLETION_INDICATOR_CODE
...
def fetch_indicator_for_countries(country_codes: list[str]) -> pd.DataFrame:
    ...
    url = (
        f"{WB_API_BASE}/country/{joined}/indicator/{GIRLS_PRIMARY_COMPLETION_INDICATOR_CODE}"
