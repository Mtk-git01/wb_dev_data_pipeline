...
from src.config import AZE_FOREIGN_TRADE_SOURCE_NAME

def transform_aze_foreign_trade_periodic(raw_df: pd.DataFrame) -> pd.DataFrame:
    df = raw_df.copy()
    ...
    df["source_name"] = AZE_FOREIGN_TRADE_SOURCE_NAME
