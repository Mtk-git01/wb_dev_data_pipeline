...
from src.config import (
    GIRLS_PRIMARY_COMPLETION_INDICATOR_CODE,
    GIRLS_PRIMARY_COMPLETION_INDICATOR_NAME,
    GIRLS_PRIMARY_COMPLETION_SOURCE_NAME,
)
...
def transform_wb_indicator(df: pd.DataFrame) -> pd.DataFrame:
    ...
    out["indicator_code"] = GIRLS_PRIMARY_COMPLETION_INDICATOR_CODE
    out["indicator_name"] = out["indicator_name"].fillna(GIRLS_PRIMARY_COMPLETION_INDICATOR_NAME)
    out["source_name"] = GIRLS_PRIMARY_COMPLETION_SOURCE_NAME
